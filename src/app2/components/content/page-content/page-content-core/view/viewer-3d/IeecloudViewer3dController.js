...
export default class IeecloudViewer3dController {
    ...
    init(container) {
        ...
        scope.#service.readVertex(window.VITE_APP_SERVER_URL, import.meta.env.VITE_CONTENT_3D_VERTEX_FILE_NAME, function (vertexMap) {
            scope.#vertexMap = vertexMap;

            let renderModel = window.VITE_APP_STATIC_STORAGE + "/" + scope.#node.properties.viewerModel;
