...
export default class IeecloudMapRendererController {
    ...
    init(container){
        ...
        mapService.readSettingsFile(import.meta.env.APP_SERVER_URL, import.meta.env.VITE_CONTENT_MAP_ZOOM, function (zoomMap) {
            mapService.readSettingsFile(import.meta.env.APP_SERVER_URL, import.meta.env.VITE_CONTENT_MAP_TYPE_SETTINGS, function (mapSettings) {
